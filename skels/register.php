...
<head>
    ...
    <link rel="stylesheet" href="../style-regster.css">
    ...
    <section class="page">
        ...
        <div class="login">
            <form method="post" class="form">
                ...
                <input type="text" class="telefono" placeholder="Numero di Telefono">
                <input type="password" class="pw" placeholder="Password">
                <input type="password" class="confirmPW" placeholder="Conferma Password">
            </form>
        </div>
        <div class="submit">
